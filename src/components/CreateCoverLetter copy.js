        ...
        return (
            <div className="container">
                ...
                <span className="navbar-text ml-auto">
                    <Link to={{pathname: "/pdfcreatecover", data:{state: this.state}}} >
                                   Push to Create PDF</Link>
                    {/* <Button outline onClick={this.toggleModal}>
                          <i className="fa fa-sign-in fa-lg" /> Create Cover Letter
                     </Button> */}
                 </span>
                 ...
                 <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this. handleCSubmit}>
                                ...
                                <FormGroup>
                                    <Label htmlFor="dearName">Dear Name</Label>
